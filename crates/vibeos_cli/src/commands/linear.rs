        ...
        match self {
            ...
            LinearCommand::EasySend { file } => {
                ...
                let title = match request.title {
                    Some(t) => t,
                    None => {
                        eprintln!("Warning: No 'title' field provided. Auto-generating from first line of 'why'.");
                        eprintln!("         Consider adding 'title: Your Issue Title' for cleaner Linear issues.");
                        request
                            .why
                            .lines()
